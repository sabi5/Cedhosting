              ...
              <form role="form" action ="addproduct.php" method = "post">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" id ="month" onfocusout = "validate()" placeholder="ex: 23" maxlength="15" type="text" name ="monthly_price" required><br>
                    <div class="invalid-feedback">
                        please enter valid product name
                    </div>
                  </div><br>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" id = "annual" onfocusout = "validate()" maxlength="15" placeholder="ex: 23" type="text" name ="annual_price" required><br>
                    <div class="invalid-feedback">
                        please enter valid product name
                    </div>
                  </div><br>
                ...
                <label for="">Web Space(in GB) <span style = "color:red">*</span></label>
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" onfocusout = "validate()" id="webspace" maxlength="5" placeholder="" type="text" name = "web_space" required>
                    <div class="invalid-feedback">
                        please enter valid product name
                    </div>
                  </div>
                ...
                <label for="">Bandwidth (in GB) <span style = "color:red">*</span></label>
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" onfocusout = "validate()" id="bandwidth" maxlength="5" placeholder="" type="text" name = "bandwidth" required>
                    <div class="invalid-feedback">
                        please enter valid product name
                    </div>
                  </div>
