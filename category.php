                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr id= "<?php echo $value['id']; ?>">
                      ...
                      <td data-target="link"><?php echo $value['link']; ?></td>
                      ...
                      <td><a href="category.php" data-role="update" data-id="<?php echo $value['id']; ?>" class ="edit_data" data-toggle="modal" data-target="#exampleModalSignUp"><i class='fas fa-edit' style='font-size:24px'></i></a></td>
